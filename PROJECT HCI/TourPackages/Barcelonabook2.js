                    ...
                    <tr>
                        ...
                        <![endif]-->
                            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="contentMainTable">
                                ...
                                Name: ${userDetails.firstName} ${userDetails.surname}<br><br>
                                Telephone: ${userDetails.telephone}<br><br>
    ...
    Email.send({
        ...
        message => {
            Swal.fire({
                ...
                window.location.href = "Barcelonabook3.html";
            });
        }
    );
}
...
document.querySelector('.next').addEventListener("click", () => {
    if (window.location.pathname.includes("Barcelonabook2.html")) {
        Swal.fire({
