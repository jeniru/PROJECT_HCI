                    ...
                    <tr>
                        ...
                        <![endif]-->
                            <table align="center" role="presentation" cellspacing="0" cellpadding="0" border="0" width="600" style="margin: auto;" class="contentMainTable">
                                ...
                                Payment Method: ${paymentDetails.paymentMethod}<br><br>
                                Card Number: ${paymentDetails.cardNumber}<br><br>
                                Expiration Date: ${paymentDetails.expirationDate}<br><br>
                                Security Code: ${paymentDetails.securityCode}<br><br>
                                </h1></td></tr>
...
document.querySelector('.next').addEventListener("click", () => {
    if (window.location.pathname.includes("Barcelonabook3.html")) {
        Swal.fire({
